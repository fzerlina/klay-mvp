  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        label: "Inventory",
        to: "/inventory",
        icon: <svg viewBox="0 0 24 24"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><polyline points="3 5 4 6 6 4"/><polyline points="3 11 4 12 6 10"/><polyline points="3 17 4 18 6 16"/></svg>,
      },
      {
        label: "Fixed Assets",
        to: "/assets",
        icon: <svg viewBox="0 0 24 24"><path d="M3 21h18"/><path d="M5 21V7l7-4 7 4v14"/><path d="M9 21v-6h6v6"/><path d="M9 12h.01M15 12h.01M9 8h.01M15 8h.01"/></svg>,
      },
    ],
  },
  {
